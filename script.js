  ...
  array.forEach(element => {
    container.innerHTML += `
      <div class="card">
        ...
        <button onclick="openModal('${element.title}', '${element.description}', '${element.image}', '${element.price}', '${element.currency}')">Подробнее</button>
      </div>
    `
  });
}

function openModal(title, description, image, price, currency) {
